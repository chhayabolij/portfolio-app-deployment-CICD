...
pipeline {
  ...
  stages {
    ...
    stage('Checkout Repository') {
      steps {
        git url: 'https://github.com/mansikadam1100/portfolio-app-deployment-CICD.git', branch: 'main'
      }
    }
...
|:--------:|----------------|---------------|
| 1️⃣ | **github Dashboard** | ![](./img/17.png)) |
| 2️⃣ | **Build Success in Jenkins** | ![](./img/Screenshot%202025-11-07%20181710.png) |
| 3️⃣ | **Portfolio Deployed on AWS EC2** | ![](./img/WhatsApp%20Image%202025-12-14%20at%205.01.12%20PM.jpeg) |
